...
public class Pass2Macro {
    public static void main(String args[]) {
        ...
        for (i = 0; i < output.length; i++) {
            ...
            // print(arr4, arr5, op1, op2, op3);
            System.out.println();
        }

    }

    public static void print(String a, String b, String c, String d, String e) {
        if (a != null) {
            System.out.print(a);
        }
        System.out.print("\t");
